 ...
 <main className="page-content">
  <div className="about-container">
    ...
    <section className="about-hero">
      <h1>Qui est <span style={{ color: "#13955e" }}>Tech For All</span> ?</h1>
    </section>
    ...
    <section data-aos="fade-right" data-aos-delay="300" data-aos-duration="1000"className="about-section">
      ...
      <div className="mission-content">
        <p>
          <strong>Tech For All</strong> est une plateforme inclusive dédiée à rendre la technologie accessible à tous, en particulier aux personnes en situation de handicap.
        </p>
        <p>
